...
<style>
    * {
    ...
    .payment-option:hover {
        border-color: #dc3545;
        /* Đổi viền sang màu đỏ khi hover */
    }
    ...
    .action-buttons a {
        background: #f5f5f5;
        color: #dc3545;
        /* Đổi màu chữ nút "Quay về giỏ hàng" sang đỏ */
        border: 1px solid #ddd;
    }
...
<div class="container">
    <div class="checkout-wrapper">
        ...
        <div class="checkout-right">
            <div class="section-title">Đơn hàngg</div>
